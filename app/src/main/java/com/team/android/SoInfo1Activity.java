...
public class SoInfo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_anterior).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SoInfo1Activity.this, SoBnActivity.class));
            }
        });
    }

    public void iniciaSiguiente() {
        Intent myIntent = new Intent(this, SoInfo2Activity.class);
